...
Careless responses will ruin data, especially when there are 10% or more participants respond carelessly [@woods2006]. From @fig-show-careless, it shows that participants perform badly (unmotivated) in only two games, which are known to be difficult. So we can conclude that participants were all motivated to fulfill all the tasks, there is no need to screen unmotivated participants.
