...
```{r}
#| fig-cap: Example Figure1. MKDA result plot for fMRI studies using Wisconsin Card Sorting Games
knitr::include_graphics("wisconsin.png")
```

```{r}
#| fig-cap: Example Figure1. MKDA result plot for fMRI studies using Stroop task
